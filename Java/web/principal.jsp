...
<div class="content">
  ...
  <div id = "content-left">
    <h3>Olá, Seja bem vindo a Área do Administrador. </h3>
        ...
        <p>
            <b> Controle de Agenda: </b> Aba para o tabela de todos os agendamentos realizados por clientes no site, o qual pode ser editado manualmente também por um administrador, dependendo se houver algum problema com o usuário.
        </p>
        <p>
