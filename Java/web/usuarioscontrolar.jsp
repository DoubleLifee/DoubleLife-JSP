...
<html>
    ...
    <body>
        <%@include file="acessoadm.jsp"%>
            ...
            <table>
            <tr><th> ID</th><th>Nome</th><th>Email</th><th>Senha</th><th>CPF</th> <th>CEP</th> <th>Telefone</th> <th>Endereco</th> <th>Tipo</th> <th>Status</th> <th colspan="3">Ações</td></tr>
                ...
                <tr>
                    ...
                    <td><a href="usuariobloquear.jsp?id=${usuarios.getId()}&status=${usuario.getStatus()}" alt="Bloquear Usuário"><img src="imagens/Block.png"  width ="48" height = "48"></a></td>
            ...
            <a href="usuariocadastrarform.jsp"><img src="./imagens/incluir.png" alt="Incluir Usuário" width="48" height="48"></a>
    </div>
    <div class="footer">
