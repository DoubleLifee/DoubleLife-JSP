...
<body>
    ...
    <div class="container" >
            <div class="second-column" style = "background-color: white; padding: 50px 10px 50px 10px ">
                ...
                <p class="description description-second">Cadastre o usuário </p>
                <form class="form" method="post" action="usuariocadastrar.jsp">
                    ...
                    <label class="label-input">
                        ...
                        <input type="text" name="tipo" placeholder="Escolha seu tipo de usuário" required>  
