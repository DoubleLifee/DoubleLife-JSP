...
<body>
	 ...
	 <div class="container">
            <div class="second-column" style = "background-color: white; padding: 50px 10px 50px 10px ">
                ...
                <form class="form" method="post" action="enviodeemailunico.jsp?id=${usuario.getId()}">                       
                    
                    <label class="label-input">
                        <i class="fas fa-lock icon-modify"></i>
                        <input type="hidden" name="id" placeholder="Id do usuário" required value="${usuarios.getId()}">
                    </label>
